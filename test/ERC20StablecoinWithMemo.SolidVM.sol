...
contract AccessControl is Context, IAccessControl {
    ...
    string public DEFAULT_ADMIN_ROLE = "DEFAULT_ADMIN_ROLE";
    ...
    function checkRole(string role) internal view virtual {
...
contract ERC20 is Context {
    ...
    function balanceOf(address acct) returns (uint) {
...
contract EIP712 is IERC5267 {
    ...
    constructor(string memory name_, string memory version_) {
        _name = name_;
        _version = version_;
        _hashedName = keccak256(name_);
        _hashedVersion = keccak256(version_);
...
contract ERC20Compliance is ERC20 {
